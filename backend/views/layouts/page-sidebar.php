...
$acc = InfoProfile::find()->where(['user_id' => Yii::$app->user->identity->id])->one();
?>
<style>
    button.btnBt {
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right notification-dropdown" aria-labelledby="notiDropdown">
                        ...
                        <div class="notifications-wrap">
                            ...
                            <a href="#" class="media">
                                            <span class="d-flex">
<!--                                                <img src="theme1/img/users/1.jpg" class="rounded-circle" alt="">-->
                                                <?= Html::img(\Yii::$app->request->BaseUrl . '/upload/info-profile/' . $acc->avatar, ['class' => 'rounded-circle']) ?>
                                            </span>
                                <span class="media-body">
                ...
                <div class="dropdown">
                    <a class="dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                       aria-haspopup="true"
                       aria-expanded="false"><?= Html::img(\Yii::$app->request->BaseUrl . '/upload/info-profile/' . $acc->avatar, ['class' => 'avatar']) ?></a>
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        <a class="dropdown-item" href="<?= Url::to(['info-profile/update', 'id' => $acc->id]) ?>"><i
                                    class="ik ik-user dropdown-icon"></i> Thông tin tài khoản</a>
                        <a class="dropdown-item" href="<?= Url::to(['/user/doi-mat-khau','id'=>Yii::$app->user->id]) ?>"><i class="ik ik-settings dropdown-icon"></i> Thay đổi mật khẩu</a>
                        <a class="dropdown-item">
                            <form action="<?= Url::to('/site/logout')?>" method="post">
                                <?= Html::submitButton('<i class="ik ik-power dropdown-icon"></i> Đăng xuất',['class'=>'btnBt'])?>
                            </form>
                        </a>
                    </div>
                </div>
